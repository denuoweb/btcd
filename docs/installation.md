...
* Install the MSI available at: [btcd windows installer](https://github.com/denuoweb/btcd/releases)
...
```bash
git clone https://github.com/denuoweb/btcd $GOPATH/src/github.com/denuoweb/btcd
...
* [Using bootstrap.dat](https://github.com/denuoweb/btcd/blob/master/docs/configuration.md#using-bootstrapdat)
