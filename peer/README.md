...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/denuoweb/btcd/peer)
...
```bash
$ go get -u github.com/denuoweb/btcd/peer
```

## Examples

* [New Outbound Peer Example](https://pkg.go.dev/github.com/denuoweb/btcd/peer#example-package--NewOutboundPeer)  
