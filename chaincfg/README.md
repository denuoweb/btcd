...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/denuoweb/btcd/chaincfg)
...
```bash
$ go get -u github.com/denuoweb/btcd/chaincfg
```
